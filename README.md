...
На китайских торговых площадках сейчас много разновидностей NANO-подобных плат на чипах-клонах, во избежание всякого рода проблем при реализации схемы, рекомендую брать платы такие, как на картинке <img src="https://github.com/kostyamat/Car-china-radio-remote-control/blob/master/LGT8F328P.png" width="400">
